...
print('Les Wright 21 June 2023/Jasper Catley, 2024')
print('https://youtube.com/leslaboratory')
print('A Python program to convert, then display and stream thermal data from the Mileseey TR160i Thermal camera!')
print('This will display a GUI window locally on the pi, as well as hopefully streaming the data to the network.')
print('')
print('This version is basically untested, will be testing on a Raspberry Pi 3B+')
print('Including all the workarounds for Pi computers from the original script. ')
print('Seemingly there are bugs in the compiled version of cv2 that ships with the Pi!')
print('')
print('Key Bindings (for the local window):')
print('')
...
def start_streaming(width, height,fps):
    process = (
        ffmpeg
        .input('pipe:', format='rawvideo',codec="rawvideo", pix_fmt='yuyv422', s='{}x{}'.format(width, height))
        .output(
            server_url + '/stream',
