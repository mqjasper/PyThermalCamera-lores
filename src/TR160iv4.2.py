...
A Python program originally used to read, parse and display thermal data from the Topdon TC001 Thermal camera, adapted for the Mileseey TR160i!
'''
print('Les Wright 21 June 2023/Jasper Catley, May 2024')
print('https://youtube.com/leslaboratory')
print('A Python program to read, parse and display thermal data from the Mileseey TR160i Thermal camera!')
print('')
